...
-- | 'print's all values flowing \'@D@\'ownstream
...
-- | 'print's all values flowing \'@U@\'pstream
...
{-| 'putStrLn's all values flowing through it
...
-- | 'putStrLn's all values flowing \'@D@\'ownstream
...
-- | 'putStrLn's all values flowing \'@U@\'pstream
